...
namespace VLXD.Controllers
{
    public class HOADONController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaHD,MaKH,MaNV,NgayLapHD,NgayGiaoHang,TongThanhTien")] HOADON hOADON)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaHD,MaKH,MaNV,NgayLapHD,NgayGiaoHang,TongThanhTien")] HOADON hOADON)
        {
            if (ModelState.IsValid)
            {
